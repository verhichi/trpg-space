...
class GeoCornerBottomRight extends Component {
  constructor (props){
    super(props);
    this.state = { isGeoResizeMode: false };
  ...
  handleMouseDown (e){
    ...
    this.setState({ isGeoResizeMode: true });
  ...
  render() {
    return (
      <div className="map-geo-corner map-geo-corner-bottom-right" onMouseDown={this.handleMouseDown} onTouchStart={this.handleTouchStart}></div>
    );
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(GeoCornerBottomRight);
