    ...
    return (
      <Fragment>
        ...
        <div className="mb-2 f-grow-1">
          ...
          <SortableList items={this.props.noteList} onSortEnd={this.props.reorderNote} lockAxis={'y'} transitionDuration={300} lockOffset={'0px'} helperclassName={'note-selected'} useDragHandle lockToContainerEdges/>
        </div>
